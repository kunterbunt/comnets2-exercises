...
\section{Simulation}
	...
	\subsection{Configurations}
		...
		\begin{description}
			...
			We concluded from this graph that over a time slice of $300\text{s}$ you can already find a reasonable average that stands in a meaningful relation to any other $300\text{s}$ time period.
